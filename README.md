...
| 날짜 | 산출물 | 설명 |
|---|---|---|
| 2026-07-25 | [claude-code-install-pitfalls](./claude-code-install-pitfalls/) | Opus 5가 나왔는데 "최신" 클로드 코드엔 4.8만: stable 채널 고착과 Agent SDK 번들 CLI가 범인. 필요한 버전(CLI 2.1.220 · SDK 0.3.220)과 점검 레시피 (docker 컨테이너 실측) |
