...
| 2026-08-10 | [10gbe-transfer-bottlenecks](./10gbe-transfer-bottlenecks/) | 10G 랜인데 151MB/s: rsync 구현·ssh 암호화·라이브러리 버퍼·커널 소켓 버퍼 상한을 한 겹씩 벗겨 872MB/s까지 (readahead 힌트 A/B 검증 포함) |
