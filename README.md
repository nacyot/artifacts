...
| 날짜 | 산출물 | 설명 |
|---|---|---|
| 2026-08-22 | [dgx-spark-node-setup](./dgx-spark-node-setup/) | ASUS Ascent GX10(DGX Spark) 한 대를 추론 서버로: 필수(서버모드·드라이버 595·PD FW·보안) / 추천(GPU·CPU 클럭 상한 스윕 그래프, vLLM 스핀 패치) / 트러블슈팅 / 직접 검증한 레시피(ollama Qwen3.8-27B, DS4F EXL3) |
